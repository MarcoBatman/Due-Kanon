...
public class Barrel {
   ...
   float angle;
    ...
    Barrel(PApplet p,Cannon c,imageLoader iL,ArrayList<Ducks> aD,int score){
        this.c=c;
        this.p = p;
        this.iL = iL;
        duckList=aD;
    ...
    void shoot(){
bullets.add(new Bullet(angle-p.radians(90),bLocation.x,bLocation.y,p,iL,duckList,score));
